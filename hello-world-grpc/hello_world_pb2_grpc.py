...
class HelloWorldStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Hello = channel.unary_unary(
                ...
                response_deserializer=hello__world__pb2.Response.FromString,
                )
...
def add_HelloWorldServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Hello': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=hello__world__pb2.Response.SerializeToString,
            ),
    }
...
class HelloWorld(object):
    ...
    def Hello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/HelloWorld/Hello',
            hello__world__pb2.Request.SerializeToString,
            hello__world__pb2.Response.FromString,
